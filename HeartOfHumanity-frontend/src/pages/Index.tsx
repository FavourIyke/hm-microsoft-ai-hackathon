...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="bg-relief-purple py-16 flex-grow">
          ...
          <div className="flex flex-col md:flex-row-reverse gap-8">
            ...
            <div className="w-full md:w-2/3 flex flex-col items-start text-left animate-scale-in">
              ...
              <p className="text-xl md:text-2xl text-relief-darkGray max-w-3xl mb-8">
                AI-powered platform helping NGOs collect data, track needs, and match resources 
              ...
              <div className="flex flex-wrap gap-4">
                ...
                <Button 
                  className="bg-relief-orange hover:bg-orange-600 text-white text-lg py-6 px-8 rounded-lg flex items-center gap-2 shadow-lg transition-all hover:translate-y-[-2px]"
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">Empower Crisis Response</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="flex flex-col items-center text-center p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all hover:border-relief-blue">
              ...
              <h3 className="text-xl font-bold mb-3">Crisis Reporting</h3>
              <p className="text-gray-600">
                Submit reports via text or voice recording to quickly document needs in crisis areas
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all hover:border-relief-orange">
              ...
              <p className="text-gray-600">
                Get intelligent recommendations and actionable insights powered by AI analysis
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all hover:border-green-600">
              ...
              <h3 className="text-xl font-bold mb-3">Resource Tracking</h3>
              <p className="text-gray-600">
                Track the status of dispatched resources and monitor progress in real-time
              </p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-all hover:border-purple-600">
              ...
              <h3 className="text-xl font-bold mb-3">Project Funding</h3>
              <p className="text-gray-600">
                Support relief projects directly with funding from organizations and individuals
              </p>
            </div>
          </div>
        </div>
